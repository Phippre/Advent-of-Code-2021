#NOT MY CODE. COULDN'T FIGURE IT OUT. GONNA CHOCK IT UP AS A LEANING EXPERIENCE

from datetime import datetime

start_time = datetime.now()
starting_fish = [int(i) for i in open("C:/Users/parke/Documents/GitHub/Advent-of-Code-2021/Day 6/fish.txt", "r").read().split(',')]
total = 0
